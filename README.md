...
- [RustAttack](#rust-attack)
  * [Examples](#examples)
    * [DLLs](#dlls)
      ...
      - [Shellcode - CreateRemoteThread method](#shellcode---createremotethread-method)
      - [Shellcode - CreateThread method](#shellcode---createthread-method)
...
```
#### Shellcode - CreateRemoteThread method
